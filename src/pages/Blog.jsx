  ...
  return (
    <>
      <div className="blog w-full  flex flex-col items-center justify-center py-10 lg:max-w-[1920px] lg:py-[120px] lg:gap-20">
        ...
        <section className="blog-main flex lg:gap-6 lg:items-start lg:justify-start ">
          <div className="main-ariticle flex flex-col items-center justify-center lg:gap-16 lg:max-w-[966px]">
            {BLOG_LIST.map((item, index) => {
              return (
                <div
                  className="ariticle-item flex items-start justify-start lg:gap-4"
                  key={index + "" + item.id}
                >
                  ...
                  <div className="item-content flex flex-col items-start justify-start lg:gap-4">
                    <div className="content-tags flex item-center justify-center lg:gap-4">
                      ...
                      <div className="tag bg-[#F1F1F1] border border-[#F1F1F1] rounded-2xl lg:px-3 lg:py-1">
          ...
          <div className="main-category  bg-[#FAFAFA]  flex flex-col items-center justify-center lg:p-20 lg:gap-8">
            {
